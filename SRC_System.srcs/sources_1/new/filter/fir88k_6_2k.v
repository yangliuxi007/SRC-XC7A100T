...
// Generated on: 2022-04-19 16:05:45
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: fir88k_6_2k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  parameter signed [15:0] coeff3 = 16'b1111111111111010; //sfix16_En17
  parameter signed [15:0] coeff4 = 16'b1111111111011010; //sfix16_En17
  parameter signed [15:0] coeff5 = 16'b1111111110100100; //sfix16_En17
  parameter signed [15:0] coeff6 = 16'b1111111101100111; //sfix16_En17
  parameter signed [15:0] coeff7 = 16'b1111111100111011; //sfix16_En17
  parameter signed [15:0] coeff8 = 16'b1111111100111111; //sfix16_En17
  parameter signed [15:0] coeff9 = 16'b1111111110010000; //sfix16_En17
  parameter signed [15:0] coeff10 = 16'b0000000000111011; //sfix16_En17
  parameter signed [15:0] coeff11 = 16'b0000000100110100; //sfix16_En17
  parameter signed [15:0] coeff12 = 16'b0000001001001111; //sfix16_En17
  parameter signed [15:0] coeff13 = 16'b0000001101000011; //sfix16_En17
  parameter signed [15:0] coeff14 = 16'b0000001110110111; //sfix16_En17
  parameter signed [15:0] coeff15 = 16'b0000001101010111; //sfix16_En17
  parameter signed [15:0] coeff16 = 16'b0000000111101011; //sfix16_En17
  parameter signed [15:0] coeff17 = 16'b1111111101110011; //sfix16_En17
  parameter signed [15:0] coeff18 = 16'b1111110000110011; //sfix16_En17
  parameter signed [15:0] coeff19 = 16'b1111100010111011; //sfix16_En17
  parameter signed [15:0] coeff20 = 16'b1111010111011000; //sfix16_En17
  parameter signed [15:0] coeff21 = 16'b1111010001110110; //sfix16_En17
  parameter signed [15:0] coeff22 = 16'b1111010101110110; //sfix16_En17
  parameter signed [15:0] coeff23 = 16'b1111100110000001; //sfix16_En17
  parameter signed [15:0] coeff24 = 16'b0000000011011010; //sfix16_En17
  parameter signed [15:0] coeff25 = 16'b0000101101000101; //sfix16_En17
  parameter signed [15:0] coeff26 = 16'b0001011111111011; //sfix16_En17
  parameter signed [15:0] coeff27 = 16'b0010010111000001; //sfix16_En17
  parameter signed [15:0] coeff28 = 16'b0011001100001010; //sfix16_En17
  parameter signed [15:0] coeff29 = 16'b0011111000111010; //sfix16_En17
  parameter signed [15:0] coeff30 = 16'b0100010111011110; //sfix16_En17
  parameter signed [15:0] coeff31 = 16'b0100100011110000; //sfix16_En17
  parameter signed [15:0] coeff32 = 16'b0100010111011110; //sfix16_En17
  parameter signed [15:0] coeff33 = 16'b0011111000111010; //sfix16_En17
  parameter signed [15:0] coeff34 = 16'b0011001100001010; //sfix16_En17
  parameter signed [15:0] coeff35 = 16'b0010010111000001; //sfix16_En17
  parameter signed [15:0] coeff36 = 16'b0001011111111011; //sfix16_En17
  parameter signed [15:0] coeff37 = 16'b0000101101000101; //sfix16_En17
  parameter signed [15:0] coeff38 = 16'b0000000011011010; //sfix16_En17
  parameter signed [15:0] coeff39 = 16'b1111100110000001; //sfix16_En17
  parameter signed [15:0] coeff40 = 16'b1111010101110110; //sfix16_En17
  parameter signed [15:0] coeff41 = 16'b1111010001110110; //sfix16_En17
  parameter signed [15:0] coeff42 = 16'b1111010111011000; //sfix16_En17
  parameter signed [15:0] coeff43 = 16'b1111100010111011; //sfix16_En17
  parameter signed [15:0] coeff44 = 16'b1111110000110011; //sfix16_En17
  parameter signed [15:0] coeff45 = 16'b1111111101110011; //sfix16_En17
  parameter signed [15:0] coeff46 = 16'b0000000111101011; //sfix16_En17
  parameter signed [15:0] coeff47 = 16'b0000001101010111; //sfix16_En17
  parameter signed [15:0] coeff48 = 16'b0000001110110111; //sfix16_En17
  parameter signed [15:0] coeff49 = 16'b0000001101000011; //sfix16_En17
  parameter signed [15:0] coeff50 = 16'b0000001001001111; //sfix16_En17
  parameter signed [15:0] coeff51 = 16'b0000000100110100; //sfix16_En17
  parameter signed [15:0] coeff52 = 16'b0000000000111011; //sfix16_En17
  parameter signed [15:0] coeff53 = 16'b1111111110010000; //sfix16_En17
  parameter signed [15:0] coeff54 = 16'b1111111100111111; //sfix16_En17
  parameter signed [15:0] coeff55 = 16'b1111111100111011; //sfix16_En17
  parameter signed [15:0] coeff56 = 16'b1111111101100111; //sfix16_En17
  parameter signed [15:0] coeff57 = 16'b1111111110100100; //sfix16_En17
  parameter signed [15:0] coeff58 = 16'b1111111111011010; //sfix16_En17
  parameter signed [15:0] coeff59 = 16'b1111111111111010; //sfix16_En17
