...
////////////////////////////////////////////////////////////////
//Module Architecture: fir96k_6_2k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  wire signed [27:0] mul_temp_1; // sfix28_En28
  wire signed [30:0] product58; // sfix31_En31
  wire signed [27:0] mul_temp_2; // sfix28_En28
  wire signed [30:0] product57; // sfix31_En31
  wire signed [27:0] mul_temp_3; // sfix28_En28
  wire signed [30:0] product56; // sfix31_En31
  wire signed [27:0] mul_temp_4; // sfix28_En28
  wire signed [30:0] product55; // sfix31_En31
  wire signed [27:0] mul_temp_5; // sfix28_En28
  wire signed [30:0] product54; // sfix31_En31
  wire signed [27:0] mul_temp_6; // sfix28_En28
  wire signed [30:0] product53; // sfix31_En31
  wire signed [27:0] mul_temp_7; // sfix28_En28
  wire signed [30:0] product52; // sfix31_En31
  wire signed [27:0] mul_temp_8; // sfix28_En28
  wire signed [30:0] product51; // sfix31_En31
  wire signed [27:0] mul_temp_9; // sfix28_En28
  wire signed [30:0] product50; // sfix31_En31
  wire signed [27:0] mul_temp_10; // sfix28_En28
  wire signed [30:0] product49; // sfix31_En31
  wire signed [27:0] mul_temp_11; // sfix28_En28
  wire signed [30:0] product48; // sfix31_En31
  wire signed [27:0] mul_temp_12; // sfix28_En28
  wire signed [30:0] product47; // sfix31_En31
  wire signed [27:0] mul_temp_13; // sfix28_En28
  wire signed [30:0] product46; // sfix31_En31
  wire signed [27:0] mul_temp_14; // sfix28_En28
  wire signed [30:0] product45; // sfix31_En31
  wire signed [27:0] mul_temp_15; // sfix28_En28
  wire signed [30:0] product44; // sfix31_En31
  wire signed [27:0] mul_temp_16; // sfix28_En28
  wire signed [30:0] product43; // sfix31_En31
  wire signed [27:0] mul_temp_17; // sfix28_En28
  wire signed [30:0] product42; // sfix31_En31
  wire signed [27:0] mul_temp_18; // sfix28_En28
  wire signed [30:0] product41; // sfix31_En31
  wire signed [27:0] mul_temp_19; // sfix28_En28
  wire signed [30:0] product40; // sfix31_En31
  wire signed [27:0] mul_temp_20; // sfix28_En28
  wire signed [30:0] product39; // sfix31_En31
  wire signed [27:0] mul_temp_21; // sfix28_En28
  wire signed [30:0] product38; // sfix31_En31
  wire signed [27:0] mul_temp_22; // sfix28_En28
  wire signed [30:0] product37; // sfix31_En31
  wire signed [27:0] mul_temp_23; // sfix28_En28
  wire signed [30:0] product36; // sfix31_En31
  wire signed [27:0] mul_temp_24; // sfix28_En28
  wire signed [30:0] product35; // sfix31_En31
  wire signed [27:0] mul_temp_25; // sfix28_En28
  wire signed [30:0] product34; // sfix31_En31
  wire signed [27:0] mul_temp_26; // sfix28_En28
  wire signed [30:0] product33; // sfix31_En31
  wire signed [27:0] mul_temp_27; // sfix28_En28
  wire signed [30:0] product32; // sfix31_En31
  wire signed [27:0] mul_temp_28; // sfix28_En28
  wire signed [30:0] product31; // sfix31_En31
  wire signed [27:0] mul_temp_29; // sfix28_En28
  wire signed [30:0] product30; // sfix31_En31
  wire signed [27:0] mul_temp_30; // sfix28_En28
  wire signed [30:0] product29; // sfix31_En31
  wire signed [27:0] mul_temp_31; // sfix28_En28
  wire signed [30:0] product28; // sfix31_En31
  wire signed [27:0] mul_temp_32; // sfix28_En28
  wire signed [30:0] product27; // sfix31_En31
  wire signed [27:0] mul_temp_33; // sfix28_En28
  wire signed [30:0] product26; // sfix31_En31
  wire signed [27:0] mul_temp_34; // sfix28_En28
  wire signed [30:0] product25; // sfix31_En31
  wire signed [27:0] mul_temp_35; // sfix28_En28
  wire signed [30:0] product24; // sfix31_En31
  wire signed [27:0] mul_temp_36; // sfix28_En28
  wire signed [30:0] product23; // sfix31_En31
  wire signed [27:0] mul_temp_37; // sfix28_En28
  wire signed [30:0] product22; // sfix31_En31
  wire signed [27:0] mul_temp_38; // sfix28_En28
  wire signed [30:0] product21; // sfix31_En31
  wire signed [27:0] mul_temp_39; // sfix28_En28
  wire signed [30:0] product20; // sfix31_En31
  wire signed [27:0] mul_temp_40; // sfix28_En28
  wire signed [30:0] product19; // sfix31_En31
  wire signed [27:0] mul_temp_41; // sfix28_En28
  wire signed [30:0] product18; // sfix31_En31
  wire signed [27:0] mul_temp_42; // sfix28_En28
  wire signed [30:0] product17; // sfix31_En31
  wire signed [27:0] mul_temp_43; // sfix28_En28
  wire signed [30:0] product16; // sfix31_En31
  wire signed [27:0] mul_temp_44; // sfix28_En28
  wire signed [30:0] product15; // sfix31_En31
  wire signed [27:0] mul_temp_45; // sfix28_En28
  wire signed [30:0] product14; // sfix31_En31
  wire signed [27:0] mul_temp_46; // sfix28_En28
  wire signed [30:0] product13; // sfix31_En31
  wire signed [27:0] mul_temp_47; // sfix28_En28
  wire signed [30:0] product12; // sfix31_En31
  wire signed [27:0] mul_temp_48; // sfix28_En28
  wire signed [30:0] product11; // sfix31_En31
  wire signed [27:0] mul_temp_49; // sfix28_En28
  wire signed [30:0] product10; // sfix31_En31
  wire signed [27:0] mul_temp_50; // sfix28_En28
  wire signed [30:0] product9; // sfix31_En31
  wire signed [27:0] mul_temp_51; // sfix28_En28
  wire signed [30:0] product8; // sfix31_En31
  wire signed [27:0] mul_temp_52; // sfix28_En28
  wire signed [30:0] product7; // sfix31_En31
  wire signed [27:0] mul_temp_53; // sfix28_En28
  wire signed [30:0] product6; // sfix31_En31
  wire signed [27:0] mul_temp_54; // sfix28_En28
  wire signed [30:0] product5; // sfix31_En31
  wire signed [27:0] mul_temp_55; // sfix28_En28
  wire signed [30:0] product4; // sfix31_En31
  wire signed [27:0] mul_temp_56; // sfix28_En28
  wire signed [30:0] product3; // sfix31_En31
  wire signed [27:0] mul_temp_57; // sfix28_En28
  wire signed [30:0] product2; // sfix31_En31
  wire signed [27:0] mul_temp_58; // sfix28_En28
