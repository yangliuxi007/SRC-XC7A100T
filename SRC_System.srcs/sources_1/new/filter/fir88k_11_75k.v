...
////////////////////////////////////////////////////////////////
//Module Architecture: fir88k_11_75k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  parameter signed [15:0] coeff4 = 16'b1111111111101100; //sfix16_En16
  parameter signed [15:0] coeff5 = 16'b0000000000001001; //sfix16_En16
  parameter signed [15:0] coeff6 = 16'b0000000001000001; //sfix16_En16
  parameter signed [15:0] coeff7 = 16'b0000000001100101; //sfix16_En16
  parameter signed [15:0] coeff8 = 16'b0000000000111100; //sfix16_En16
  parameter signed [15:0] coeff9 = 16'b1111111110111011; //sfix16_En16
  parameter signed [15:0] coeff10 = 16'b1111111100101001; //sfix16_En16
  parameter signed [15:0] coeff11 = 16'b1111111100000111; //sfix16_En16
  parameter signed [15:0] coeff12 = 16'b1111111110110000; //sfix16_En16
  parameter signed [15:0] coeff13 = 16'b0000000011101110; //sfix16_En16
  parameter signed [15:0] coeff14 = 16'b0000000111110000; //sfix16_En16
  parameter signed [15:0] coeff15 = 16'b0000000111000000; //sfix16_En16
  parameter signed [15:0] coeff16 = 16'b0000000000001100; //sfix16_En16
  parameter signed [15:0] coeff17 = 16'b1111110110100111; //sfix16_En16
  parameter signed [15:0] coeff18 = 16'b1111110001000100; //sfix16_En16
  parameter signed [15:0] coeff19 = 16'b1111110101100000; //sfix16_En16
  parameter signed [15:0] coeff20 = 16'b0000000011111111; //sfix16_En16
  parameter signed [15:0] coeff21 = 16'b0000010100100101; //sfix16_En16
  parameter signed [15:0] coeff22 = 16'b0000011010110100; //sfix16_En16
  parameter signed [15:0] coeff23 = 16'b0000001101110011; //sfix16_En16
  parameter signed [15:0] coeff24 = 16'b1111110000001100; //sfix16_En16
  parameter signed [15:0] coeff25 = 16'b1111010010011011; //sfix16_En16
  parameter signed [15:0] coeff26 = 16'b1111001100001110; //sfix16_En16
  parameter signed [15:0] coeff27 = 16'b1111101111101110; //sfix16_En16
  parameter signed [15:0] coeff28 = 16'b0000111101001100; //sfix16_En16
  parameter signed [15:0] coeff29 = 16'b0010011110111111; //sfix16_En16
  parameter signed [15:0] coeff30 = 16'b0011110001011000; //sfix16_En16
  parameter signed [15:0] coeff31 = 16'b0100010010111111; //sfix16_En16
  parameter signed [15:0] coeff32 = 16'b0011110001011000; //sfix16_En16
  parameter signed [15:0] coeff33 = 16'b0010011110111111; //sfix16_En16
  parameter signed [15:0] coeff34 = 16'b0000111101001100; //sfix16_En16
  parameter signed [15:0] coeff35 = 16'b1111101111101110; //sfix16_En16
  parameter signed [15:0] coeff36 = 16'b1111001100001110; //sfix16_En16
  parameter signed [15:0] coeff37 = 16'b1111010010011011; //sfix16_En16
  parameter signed [15:0] coeff38 = 16'b1111110000001100; //sfix16_En16
  parameter signed [15:0] coeff39 = 16'b0000001101110011; //sfix16_En16
  parameter signed [15:0] coeff40 = 16'b0000011010110100; //sfix16_En16
  parameter signed [15:0] coeff41 = 16'b0000010100100101; //sfix16_En16
  parameter signed [15:0] coeff42 = 16'b0000000011111111; //sfix16_En16
  parameter signed [15:0] coeff43 = 16'b1111110101100000; //sfix16_En16
  parameter signed [15:0] coeff44 = 16'b1111110001000100; //sfix16_En16
  parameter signed [15:0] coeff45 = 16'b1111110110100111; //sfix16_En16
  parameter signed [15:0] coeff46 = 16'b0000000000001100; //sfix16_En16
  parameter signed [15:0] coeff47 = 16'b0000000111000000; //sfix16_En16
  parameter signed [15:0] coeff48 = 16'b0000000111110000; //sfix16_En16
  parameter signed [15:0] coeff49 = 16'b0000000011101110; //sfix16_En16
  parameter signed [15:0] coeff50 = 16'b1111111110110000; //sfix16_En16
  parameter signed [15:0] coeff51 = 16'b1111111100000111; //sfix16_En16
  parameter signed [15:0] coeff52 = 16'b1111111100101001; //sfix16_En16
  parameter signed [15:0] coeff53 = 16'b1111111110111011; //sfix16_En16
  parameter signed [15:0] coeff54 = 16'b0000000000111100; //sfix16_En16
  parameter signed [15:0] coeff55 = 16'b0000000001100101; //sfix16_En16
  parameter signed [15:0] coeff56 = 16'b0000000001000001; //sfix16_En16
  parameter signed [15:0] coeff57 = 16'b0000000000001001; //sfix16_En16
  parameter signed [15:0] coeff58 = 16'b1111111111101100; //sfix16_En16
  ...
  assign mul_temp_45 = delay_pipeline[14] * coeff15;
  assign product15 = $signed({mul_temp_45[26:0], 4'b0000});

  assign mul_temp_46 = delay_pipeline[13] * coeff14;
  assign product14 = $signed({mul_temp_46[26:0], 4'b0000});

  assign mul_temp_47 = delay_pipeline[12] * coeff13;
  assign product13 = $signed({mul_temp_47[26:0], 4'b0000});

  assign mul_temp_48 = delay_pipeline[11] * coeff12;
  assign product12 = $signed({mul_temp_48[26:0], 4'b0000});

  assign mul_temp_49 = delay_pipeline[10] * coeff11;
