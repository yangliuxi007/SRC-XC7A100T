...
#
# Generated by export_simulation on Mon Apr 04 15:33:31 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './data_waiting_area_1.sh' script.

./data_waiting_area_1.sh -reset_run
...
./data_waiting_area_1.sh -noclean_files

For more information on the script, please type './data_waiting_area_1.sh -help'.
