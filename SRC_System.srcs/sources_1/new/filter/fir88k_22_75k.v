...
////////////////////////////////////////////////////////////////
//Module Architecture: fir88k_22_75k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  parameter signed [15:0] coeff6 = 16'b0000000000001001; //sfix16_En15
  parameter signed [15:0] coeff7 = 16'b0000000000110010; //sfix16_En15
  parameter signed [15:0] coeff8 = 16'b1111111111101001; //sfix16_En15
  parameter signed [15:0] coeff9 = 16'b1111111110101101; //sfix16_En15
  parameter signed [15:0] coeff10 = 16'b0000000000110001; //sfix16_En15
  parameter signed [15:0] coeff11 = 16'b0000000001111100; //sfix16_En15
  parameter signed [15:0] coeff12 = 16'b1111111110100101; //sfix16_En15
  parameter signed [15:0] coeff13 = 16'b1111111101010101; //sfix16_En15
  parameter signed [15:0] coeff14 = 16'b0000000010011001; //sfix16_En15
  parameter signed [15:0] coeff15 = 16'b0000000011011111; //sfix16_En15
  parameter signed [15:0] coeff16 = 16'b1111111100001110; //sfix16_En15
  parameter signed [15:0] coeff17 = 16'b1111111011101001; //sfix16_En15
  parameter signed [15:0] coeff18 = 16'b0000000101101111; //sfix16_En15
  parameter signed [15:0] coeff19 = 16'b0000000101001111; //sfix16_En15
  parameter signed [15:0] coeff20 = 16'b1111110111100001; //sfix16_En15
  parameter signed [15:0] coeff21 = 16'b1111111001111011; //sfix16_En15
  parameter signed [15:0] coeff22 = 16'b0000001100011010; //sfix16_En15
  parameter signed [15:0] coeff23 = 16'b0000000110111000; //sfix16_En15
  parameter signed [15:0] coeff24 = 16'b1111101101101000; //sfix16_En15
  parameter signed [15:0] coeff25 = 16'b1111111000011100; //sfix16_En15
  parameter signed [15:0] coeff26 = 16'b0000011100101001; //sfix16_En15
  parameter signed [15:0] coeff27 = 16'b0000001000001000; //sfix16_En15
  parameter signed [15:0] coeff28 = 16'b1111001100100010; //sfix16_En15
  parameter signed [15:0] coeff29 = 16'b1111110111011111; //sfix16_En15
  parameter signed [15:0] coeff30 = 16'b0010100001011111; //sfix16_En15
  parameter signed [15:0] coeff31 = 16'b0100001001010110; //sfix16_En15
  parameter signed [15:0] coeff32 = 16'b0010100001011111; //sfix16_En15
  parameter signed [15:0] coeff33 = 16'b1111110111011111; //sfix16_En15
  parameter signed [15:0] coeff34 = 16'b1111001100100010; //sfix16_En15
  parameter signed [15:0] coeff35 = 16'b0000001000001000; //sfix16_En15
  parameter signed [15:0] coeff36 = 16'b0000011100101001; //sfix16_En15
  parameter signed [15:0] coeff37 = 16'b1111111000011100; //sfix16_En15
  parameter signed [15:0] coeff38 = 16'b1111101101101000; //sfix16_En15
  parameter signed [15:0] coeff39 = 16'b0000000110111000; //sfix16_En15
  parameter signed [15:0] coeff40 = 16'b0000001100011010; //sfix16_En15
  parameter signed [15:0] coeff41 = 16'b1111111001111011; //sfix16_En15
  parameter signed [15:0] coeff42 = 16'b1111110111100001; //sfix16_En15
  parameter signed [15:0] coeff43 = 16'b0000000101001111; //sfix16_En15
  parameter signed [15:0] coeff44 = 16'b0000000101101111; //sfix16_En15
  parameter signed [15:0] coeff45 = 16'b1111111011101001; //sfix16_En15
  parameter signed [15:0] coeff46 = 16'b1111111100001110; //sfix16_En15
  parameter signed [15:0] coeff47 = 16'b0000000011011111; //sfix16_En15
  parameter signed [15:0] coeff48 = 16'b0000000010011001; //sfix16_En15
  parameter signed [15:0] coeff49 = 16'b1111111101010101; //sfix16_En15
  parameter signed [15:0] coeff50 = 16'b1111111110100101; //sfix16_En15
  parameter signed [15:0] coeff51 = 16'b0000000001111100; //sfix16_En15
  parameter signed [15:0] coeff52 = 16'b0000000000110001; //sfix16_En15
  parameter signed [15:0] coeff53 = 16'b1111111110101101; //sfix16_En15
  parameter signed [15:0] coeff54 = 16'b1111111111101001; //sfix16_En15
  parameter signed [15:0] coeff55 = 16'b0000000000110010; //sfix16_En15
  parameter signed [15:0] coeff56 = 16'b0000000000001001; //sfix16_En15
  parameter signed [15:0] coeff57 = 16'b1111111111100110; //sfix16_En15
  parameter signed [15:0] coeff58 = 16'b1111111111111110; //sfix16_En15
  ...
  assign mulpwr2_temp = (delay_pipeline[57]==12'b100000000000) ? $signed({1'b0, delay_pipeline[57]}) : -delay_pipeline[57];

  assign product58 = $signed({mulpwr2_temp[12:0], 6'b000000});

  assign mul_temp_1 = delay_pipeline[56] * coeff57;
  assign product57 = $signed({mul_temp_1[25:0], 5'b00000});

  assign mul_temp_2 = delay_pipeline[55] * coeff56;
  assign product56 = $signed({mul_temp_2[25:0], 5'b00000});

  assign mul_temp_3 = delay_pipeline[54] * coeff55;
  assign product55 = $signed({mul_temp_3[25:0], 5'b00000});

  assign mul_temp_4 = delay_pipeline[53] * coeff54;
  assign product54 = $signed({mul_temp_4[25:0], 5'b00000});
  ...
  assign product8 = $signed({mul_temp_50[25:0], 5'b00000});

  assign mul_temp_51 = delay_pipeline[6] * coeff7;
  assign product7 = $signed({mul_temp_51[25:0], 5'b00000});

  assign mul_temp_52 = delay_pipeline[5] * coeff6;
  assign product6 = $signed({mul_temp_52[25:0], 5'b00000});

  assign mul_temp_53 = delay_pipeline[4] * coeff5;
  assign product5 = $signed({mul_temp_53[25:0], 5'b00000});

  assign mulpwr2_temp_1 = (delay_pipeline[3]==12'b100000000000) ? $signed({1'b0, delay_pipeline[3]}) : -delay_pipeline[3];

  assign product4 = $signed({mulpwr2_temp_1[12:0], 6'b000000});
