...
// Generated on: 2022-04-19 16:03:28
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: fir64k_4_5k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000000000000; //sfix16_En17
  parameter signed [15:0] coeff2 = 16'b0000000000000100; //sfix16_En17
  parameter signed [15:0] coeff3 = 16'b1111111111111001; //sfix16_En17
  parameter signed [15:0] coeff4 = 16'b1111111111011000; //sfix16_En17
  parameter signed [15:0] coeff5 = 16'b1111111110100011; //sfix16_En17
  parameter signed [15:0] coeff6 = 16'b1111111101100111; //sfix16_En17
  parameter signed [15:0] coeff7 = 16'b1111111100111100; //sfix16_En17
  parameter signed [15:0] coeff8 = 16'b1111111101000011; //sfix16_En17
  parameter signed [15:0] coeff9 = 16'b1111111110010110; //sfix16_En17
  parameter signed [15:0] coeff10 = 16'b0000000001000011; //sfix16_En17
  parameter signed [15:0] coeff11 = 16'b0000000100111100; //sfix16_En17
  parameter signed [15:0] coeff12 = 16'b0000001001010101; //sfix16_En17
  parameter signed [15:0] coeff13 = 16'b0000001101000100; //sfix16_En17
  parameter signed [15:0] coeff14 = 16'b0000001110110010; //sfix16_En17
  parameter signed [15:0] coeff15 = 16'b0000001101001011; //sfix16_En17
  parameter signed [15:0] coeff16 = 16'b0000000111011010; //sfix16_En17
  parameter signed [15:0] coeff17 = 16'b1111111101011110; //sfix16_En17
  parameter signed [15:0] coeff18 = 16'b1111110000100000; //sfix16_En17
  parameter signed [15:0] coeff19 = 16'b1111100010101101; //sfix16_En17
  parameter signed [15:0] coeff20 = 16'b1111010111010100; //sfix16_En17
  parameter signed [15:0] coeff21 = 16'b1111010001111101; //sfix16_En17
  parameter signed [15:0] coeff22 = 16'b1111010110001001; //sfix16_En17
  parameter signed [15:0] coeff23 = 16'b1111100110011101; //sfix16_En17
  parameter signed [15:0] coeff24 = 16'b0000000011111010; //sfix16_En17
  parameter signed [15:0] coeff25 = 16'b0000101101100010; //sfix16_En17
  parameter signed [15:0] coeff26 = 16'b0001100000010000; //sfix16_En17
  parameter signed [15:0] coeff27 = 16'b0010010111001000; //sfix16_En17
  parameter signed [15:0] coeff28 = 16'b0011001100000001; //sfix16_En17
  parameter signed [15:0] coeff29 = 16'b0011111000100010; //sfix16_En17
  parameter signed [15:0] coeff30 = 16'b0100010110111100; //sfix16_En17
  parameter signed [15:0] coeff31 = 16'b0100100011001010; //sfix16_En17
  parameter signed [15:0] coeff32 = 16'b0100010110111100; //sfix16_En17
  parameter signed [15:0] coeff33 = 16'b0011111000100010; //sfix16_En17
  parameter signed [15:0] coeff34 = 16'b0011001100000001; //sfix16_En17
  parameter signed [15:0] coeff35 = 16'b0010010111001000; //sfix16_En17
  parameter signed [15:0] coeff36 = 16'b0001100000010000; //sfix16_En17
  parameter signed [15:0] coeff37 = 16'b0000101101100010; //sfix16_En17
  parameter signed [15:0] coeff38 = 16'b0000000011111010; //sfix16_En17
  parameter signed [15:0] coeff39 = 16'b1111100110011101; //sfix16_En17
  parameter signed [15:0] coeff40 = 16'b1111010110001001; //sfix16_En17
  parameter signed [15:0] coeff41 = 16'b1111010001111101; //sfix16_En17
  parameter signed [15:0] coeff42 = 16'b1111010111010100; //sfix16_En17
  parameter signed [15:0] coeff43 = 16'b1111100010101101; //sfix16_En17
  parameter signed [15:0] coeff44 = 16'b1111110000100000; //sfix16_En17
  parameter signed [15:0] coeff45 = 16'b1111111101011110; //sfix16_En17
  parameter signed [15:0] coeff46 = 16'b0000000111011010; //sfix16_En17
  parameter signed [15:0] coeff47 = 16'b0000001101001011; //sfix16_En17
  parameter signed [15:0] coeff48 = 16'b0000001110110010; //sfix16_En17
  parameter signed [15:0] coeff49 = 16'b0000001101000100; //sfix16_En17
  parameter signed [15:0] coeff50 = 16'b0000001001010101; //sfix16_En17
  parameter signed [15:0] coeff51 = 16'b0000000100111100; //sfix16_En17
  parameter signed [15:0] coeff52 = 16'b0000000001000011; //sfix16_En17
  parameter signed [15:0] coeff53 = 16'b1111111110010110; //sfix16_En17
  parameter signed [15:0] coeff54 = 16'b1111111101000011; //sfix16_En17
  parameter signed [15:0] coeff55 = 16'b1111111100111100; //sfix16_En17
  parameter signed [15:0] coeff56 = 16'b1111111101100111; //sfix16_En17
  parameter signed [15:0] coeff57 = 16'b1111111110100011; //sfix16_En17
  parameter signed [15:0] coeff58 = 16'b1111111111011000; //sfix16_En17
  parameter signed [15:0] coeff59 = 16'b1111111111111001; //sfix16_En17
  parameter signed [15:0] coeff60 = 16'b0000000000000100; //sfix16_En17
  parameter signed [15:0] coeff61 = 16'b0000000000000000; //sfix16_En17
  ...
  assign product60 = $signed({delay_pipeline[59][11:0], 5'b00000});

  assign mul_temp = delay_pipeline[58] * coeff59;
  assign product59 = $signed({mul_temp[27:0], 3'b000});

  assign mul_temp_1 = delay_pipeline[57] * coeff58;
  assign product58 = $signed({mul_temp_1[27:0], 3'b000});

  assign mul_temp_2 = delay_pipeline[56] * coeff57;
  assign product57 = $signed({mul_temp_2[27:0], 3'b000});

  assign mul_temp_3 = delay_pipeline[55] * coeff56;
  assign product56 = $signed({mul_temp_3[27:0], 3'b000});

  assign mul_temp_4 = delay_pipeline[54] * coeff55;
  assign product55 = $signed({mul_temp_4[27:0], 3'b000});

  assign mul_temp_5 = delay_pipeline[53] * coeff54;
  assign product54 = $signed({mul_temp_5[27:0], 3'b000});

  assign mul_temp_6 = delay_pipeline[52] * coeff53;
  assign product53 = $signed({mul_temp_6[27:0], 3'b000});

  assign mul_temp_7 = delay_pipeline[51] * coeff52;
  assign product52 = $signed({mul_temp_7[27:0], 3'b000});

  assign mul_temp_8 = delay_pipeline[50] * coeff51;
  assign product51 = $signed({mul_temp_8[27:0], 3'b000});

  assign mul_temp_9 = delay_pipeline[49] * coeff50;
  assign product50 = $signed({mul_temp_9[27:0], 3'b000});

  assign mul_temp_10 = delay_pipeline[48] * coeff49;
  assign product49 = $signed({mul_temp_10[27:0], 3'b000});

  assign mul_temp_11 = delay_pipeline[47] * coeff48;
  assign product48 = $signed({mul_temp_11[27:0], 3'b000});

  assign mul_temp_12 = delay_pipeline[46] * coeff47;
  assign product47 = $signed({mul_temp_12[27:0], 3'b000});

  assign mul_temp_13 = delay_pipeline[45] * coeff46;
  assign product46 = $signed({mul_temp_13[27:0], 3'b000});

  assign mul_temp_14 = delay_pipeline[44] * coeff45;
  assign product45 = $signed({mul_temp_14[27:0], 3'b000});

  assign mul_temp_15 = delay_pipeline[43] * coeff44;
  assign product44 = $signed({mul_temp_15[27:0], 3'b000});

  assign mul_temp_16 = delay_pipeline[42] * coeff43;
  assign product43 = $signed({mul_temp_16[27:0], 3'b000});

  assign mul_temp_17 = delay_pipeline[41] * coeff42;
  assign product42 = $signed({mul_temp_17[27:0], 3'b000});

  assign mul_temp_18 = delay_pipeline[40] * coeff41;
  assign product41 = $signed({mul_temp_18[27:0], 3'b000});

  assign mul_temp_19 = delay_pipeline[39] * coeff40;
  assign product40 = $signed({mul_temp_19[27:0], 3'b000});

  assign mul_temp_20 = delay_pipeline[38] * coeff39;
  assign product39 = $signed({mul_temp_20[27:0], 3'b000});

  assign mul_temp_21 = delay_pipeline[37] * coeff38;
  assign product38 = $signed({mul_temp_21[27:0], 3'b000});

  assign mul_temp_22 = delay_pipeline[36] * coeff37;
  assign product37 = $signed({mul_temp_22[27:0], 3'b000});

  assign mul_temp_23 = delay_pipeline[35] * coeff36;
  assign product36 = $signed({mul_temp_23[27:0], 3'b000});

  assign mul_temp_24 = delay_pipeline[34] * coeff35;
  assign product35 = $signed({mul_temp_24[27:0], 3'b000});

  assign mul_temp_25 = delay_pipeline[33] * coeff34;
  assign product34 = $signed({mul_temp_25[27:0], 3'b000});

  assign mul_temp_26 = delay_pipeline[32] * coeff33;
  assign product33 = $signed({mul_temp_26[27:0], 3'b000});

  assign mul_temp_27 = delay_pipeline[31] * coeff32;
  assign product32 = $signed({mul_temp_27[27:0], 3'b000});

  assign mul_temp_28 = delay_pipeline[30] * coeff31;
  assign product31 = $signed({mul_temp_28[27:0], 3'b000});

  assign mul_temp_29 = delay_pipeline[29] * coeff30;
  assign product30 = $signed({mul_temp_29[27:0], 3'b000});

  assign mul_temp_30 = delay_pipeline[28] * coeff29;
  assign product29 = $signed({mul_temp_30[27:0], 3'b000});

  assign mul_temp_31 = delay_pipeline[27] * coeff28;
  assign product28 = $signed({mul_temp_31[27:0], 3'b000});

  assign mul_temp_32 = delay_pipeline[26] * coeff27;
  assign product27 = $signed({mul_temp_32[27:0], 3'b000});

  assign mul_temp_33 = delay_pipeline[25] * coeff26;
  assign product26 = $signed({mul_temp_33[27:0], 3'b000});

  assign mul_temp_34 = delay_pipeline[24] * coeff25;
  assign product25 = $signed({mul_temp_34[27:0], 3'b000});

  assign mul_temp_35 = delay_pipeline[23] * coeff24;
  assign product24 = $signed({mul_temp_35[27:0], 3'b000});

  assign mul_temp_36 = delay_pipeline[22] * coeff23;
  assign product23 = $signed({mul_temp_36[27:0], 3'b000});

  assign mul_temp_37 = delay_pipeline[21] * coeff22;
  assign product22 = $signed({mul_temp_37[27:0], 3'b000});

  assign mul_temp_38 = delay_pipeline[20] * coeff21;
  assign product21 = $signed({mul_temp_38[27:0], 3'b000});

  assign mul_temp_39 = delay_pipeline[19] * coeff20;
  assign product20 = $signed({mul_temp_39[27:0], 3'b000});

  assign mul_temp_40 = delay_pipeline[18] * coeff19;
  assign product19 = $signed({mul_temp_40[27:0], 3'b000});

  assign mul_temp_41 = delay_pipeline[17] * coeff18;
  assign product18 = $signed({mul_temp_41[27:0], 3'b000});

  assign mul_temp_42 = delay_pipeline[16] * coeff17;
  assign product17 = $signed({mul_temp_42[27:0], 3'b000});

  assign mul_temp_43 = delay_pipeline[15] * coeff16;
  assign product16 = $signed({mul_temp_43[27:0], 3'b000});

  assign mul_temp_44 = delay_pipeline[14] * coeff15;
  assign product15 = $signed({mul_temp_44[27:0], 3'b000});

  assign mul_temp_45 = delay_pipeline[13] * coeff14;
  assign product14 = $signed({mul_temp_45[27:0], 3'b000});

  assign mul_temp_46 = delay_pipeline[12] * coeff13;
  assign product13 = $signed({mul_temp_46[27:0], 3'b000});

  assign mul_temp_47 = delay_pipeline[11] * coeff12;
  assign product12 = $signed({mul_temp_47[27:0], 3'b000});

  assign mul_temp_48 = delay_pipeline[10] * coeff11;
  assign product11 = $signed({mul_temp_48[27:0], 3'b000});

  assign mul_temp_49 = delay_pipeline[9] * coeff10;
  assign product10 = $signed({mul_temp_49[27:0], 3'b000});

  assign mul_temp_50 = delay_pipeline[8] * coeff9;
  assign product9 = $signed({mul_temp_50[27:0], 3'b000});

  assign mul_temp_51 = delay_pipeline[7] * coeff8;
  assign product8 = $signed({mul_temp_51[27:0], 3'b000});

  assign mul_temp_52 = delay_pipeline[6] * coeff7;
  assign product7 = $signed({mul_temp_52[27:0], 3'b000});

  assign mul_temp_53 = delay_pipeline[5] * coeff6;
  assign product6 = $signed({mul_temp_53[27:0], 3'b000});

  assign mul_temp_54 = delay_pipeline[4] * coeff5;
  assign product5 = $signed({mul_temp_54[27:0], 3'b000});

  assign mul_temp_55 = delay_pipeline[3] * coeff4;
  assign product4 = $signed({mul_temp_55[27:0], 3'b000});

  assign mul_temp_56 = delay_pipeline[2] * coeff3;
  assign product3 = $signed({mul_temp_56[27:0], 3'b000});

  assign product2 = $signed({delay_pipeline[1][11:0], 5'b00000});
