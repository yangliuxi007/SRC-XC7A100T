...
#
# Generated by export_simulation on Wed Apr 13 15:23:36 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_farrow_1.sh' script.

./fifo_farrow_1.sh -reset_run
...
./fifo_farrow_1.sh -noclean_files

For more information on the script, please type './fifo_farrow_1.sh -help'.
