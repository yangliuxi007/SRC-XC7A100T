...
#
# Generated by export_simulation on Wed Apr 13 15:23:03 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_farrow_0.sh' script.

./fifo_farrow_0.sh -reset_run
...
./fifo_farrow_0.sh -noclean_files

For more information on the script, please type './fifo_farrow_0.sh -help'.
