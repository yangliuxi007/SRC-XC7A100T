...
// Generated on: 2022-04-19 16:04:01
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: fir32k_8_2k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000000000000; //sfix16_En15
  parameter signed [15:0] coeff2 = 16'b0000000000000010; //sfix16_En15
  parameter signed [15:0] coeff3 = 16'b0000000000001000; //sfix16_En15
  parameter signed [15:0] coeff4 = 16'b1111111111111000; //sfix16_En15
  parameter signed [15:0] coeff5 = 16'b1111111111101010; //sfix16_En15
  parameter signed [15:0] coeff6 = 16'b0000000000010101; //sfix16_En15
  parameter signed [15:0] coeff7 = 16'b0000000000101010; //sfix16_En15
  parameter signed [15:0] coeff8 = 16'b1111111111010101; //sfix16_En15
  parameter signed [15:0] coeff9 = 16'b1111111110111011; //sfix16_En15
  parameter signed [15:0] coeff10 = 16'b0000000001001101; //sfix16_En15
  parameter signed [15:0] coeff11 = 16'b0000000001100100; //sfix16_En15
  parameter signed [15:0] coeff12 = 16'b1111111110000001; //sfix16_En15
  parameter signed [15:0] coeff13 = 16'b1111111101111001; //sfix16_En15
  parameter signed [15:0] coeff14 = 16'b0000000011000100; //sfix16_En15
  parameter signed [15:0] coeff15 = 16'b0000000010101110; //sfix16_En15
  parameter signed [15:0] coeff16 = 16'b1111111011011110; //sfix16_En15
  parameter signed [15:0] coeff17 = 16'b1111111100101010; //sfix16_En15
  parameter signed [15:0] coeff18 = 16'b0000000110100010; //sfix16_En15
  parameter signed [15:0] coeff19 = 16'b0000000011111110; //sfix16_En15
  parameter signed [15:0] coeff20 = 16'b1111110110101111; //sfix16_En15
  parameter signed [15:0] coeff21 = 16'b1111111011011100; //sfix16_En15
  parameter signed [15:0] coeff22 = 16'b0000001101001001; //sfix16_En15
  parameter signed [15:0] coeff23 = 16'b0000000101000111; //sfix16_En15
  parameter signed [15:0] coeff24 = 16'b1111101100111111; //sfix16_En15
  parameter signed [15:0] coeff25 = 16'b1111111010011010; //sfix16_En15
  parameter signed [15:0] coeff26 = 16'b0000011101001000; //sfix16_En15
  parameter signed [15:0] coeff27 = 16'b0000000101111110; //sfix16_En15
  parameter signed [15:0] coeff28 = 16'b1111001100001110; //sfix16_En15
  parameter signed [15:0] coeff29 = 16'b1111111001110000; //sfix16_En15
  parameter signed [15:0] coeff30 = 16'b0010100001100110; //sfix16_En15
  parameter signed [15:0] coeff31 = 16'b0100000111000010; //sfix16_En15
  parameter signed [15:0] coeff32 = 16'b0010100001100110; //sfix16_En15
  parameter signed [15:0] coeff33 = 16'b1111111001110000; //sfix16_En15
  parameter signed [15:0] coeff34 = 16'b1111001100001110; //sfix16_En15
  parameter signed [15:0] coeff35 = 16'b0000000101111110; //sfix16_En15
  parameter signed [15:0] coeff36 = 16'b0000011101001000; //sfix16_En15
  parameter signed [15:0] coeff37 = 16'b1111111010011010; //sfix16_En15
  parameter signed [15:0] coeff38 = 16'b1111101100111111; //sfix16_En15
  parameter signed [15:0] coeff39 = 16'b0000000101000111; //sfix16_En15
  parameter signed [15:0] coeff40 = 16'b0000001101001001; //sfix16_En15
  parameter signed [15:0] coeff41 = 16'b1111111011011100; //sfix16_En15
  parameter signed [15:0] coeff42 = 16'b1111110110101111; //sfix16_En15
  parameter signed [15:0] coeff43 = 16'b0000000011111110; //sfix16_En15
  parameter signed [15:0] coeff44 = 16'b0000000110100010; //sfix16_En15
  parameter signed [15:0] coeff45 = 16'b1111111100101010; //sfix16_En15
  parameter signed [15:0] coeff46 = 16'b1111111011011110; //sfix16_En15
  parameter signed [15:0] coeff47 = 16'b0000000010101110; //sfix16_En15
  parameter signed [15:0] coeff48 = 16'b0000000011000100; //sfix16_En15
  parameter signed [15:0] coeff49 = 16'b1111111101111001; //sfix16_En15
  parameter signed [15:0] coeff50 = 16'b1111111110000001; //sfix16_En15
  parameter signed [15:0] coeff51 = 16'b0000000001100100; //sfix16_En15
  parameter signed [15:0] coeff52 = 16'b0000000001001101; //sfix16_En15
  parameter signed [15:0] coeff53 = 16'b1111111110111011; //sfix16_En15
  parameter signed [15:0] coeff54 = 16'b1111111111010101; //sfix16_En15
  parameter signed [15:0] coeff55 = 16'b0000000000101010; //sfix16_En15
  parameter signed [15:0] coeff56 = 16'b0000000000010101; //sfix16_En15
  parameter signed [15:0] coeff57 = 16'b1111111111101010; //sfix16_En15
  parameter signed [15:0] coeff58 = 16'b1111111111111000; //sfix16_En15
  parameter signed [15:0] coeff59 = 16'b0000000000001000; //sfix16_En15
  parameter signed [15:0] coeff60 = 16'b0000000000000010; //sfix16_En15
  ...
  assign product60 = $signed({delay_pipeline[59][11:0], 6'b000000});
  ...
  assign product58 = $signed({mulpwr2_temp[12:0], 8'b00000000});

  assign mul_temp = delay_pipeline[56] * coeff57;
  assign product57 = $signed({mul_temp[25:0], 5'b00000});

  assign mul_temp_1 = delay_pipeline[55] * coeff56;
  assign product56 = $signed({mul_temp_1[25:0], 5'b00000});
  ...
  assign product52 = $signed({mul_temp_5[25:0], 5'b00000});

  assign mul_temp_6 = delay_pipeline[50] * coeff51;
  assign product51 = $signed({mul_temp_6[25:0], 5'b00000});
  ...
  assign product4 = $signed({mulpwr2_temp_1[12:0], 8'b00000000});

  assign product3 = $signed({delay_pipeline[2][11:0], 8'b00000000});

  assign product2 = $signed({delay_pipeline[1][11:0], 6'b000000});
