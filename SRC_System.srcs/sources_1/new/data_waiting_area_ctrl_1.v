...
module data_waiting_area_ctrl_1(
    ...
    always @(posedge module_clk or negedge sys_rstn) begin
        ...
        else if(addra_0 == 10'd1020 && wea && !lock_wea)begin
            flag[0] <= 1'b1;                   
            lock_wea <= 1'd1;
        end
        else if(addra_0 == 10'd1020 && lock_wea)
            flag[0] <= 1'b1;
        else if(addra == 11'd0 && lock_wea)
            flag[0] <= 1'b0;
        else if(!wea)
            flag[1] <= 1'b1;
    ...
    //////////// ip core part
    data_waiting_area_1 data_waiting_area_ram (
