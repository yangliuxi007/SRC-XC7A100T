...
set rc [catch {
  ...
  add_files -quiet D:/No_desktop/FPGA_part/Graduation_project/SRC_System/SRC_System.runs/synth_1/system_top.dcp
  ...
  link_design -top system_top -part xc7a100tfgg676-2
