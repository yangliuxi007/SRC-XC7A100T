...
// Generated on: 2022-04-19 16:05:08
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: fir22k_5_75k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  parameter signed [15:0] coeff3 = 16'b0000000000001000; //sfix16_En15
  parameter signed [15:0] coeff4 = 16'b0000000000000110; //sfix16_En15
  parameter signed [15:0] coeff5 = 16'b1111111111100111; //sfix16_En15
  parameter signed [15:0] coeff6 = 16'b1111111111111000; //sfix16_En15
  parameter signed [15:0] coeff7 = 16'b0000000000110100; //sfix16_En15
  parameter signed [15:0] coeff8 = 16'b0000000000000101; //sfix16_En15
  parameter signed [15:0] coeff9 = 16'b1111111110100110; //sfix16_En15
  parameter signed [15:0] coeff10 = 16'b0000000000001000; //sfix16_En15
  parameter signed [15:0] coeff11 = 16'b0000000010001100; //sfix16_En15
  parameter signed [15:0] coeff12 = 16'b1111111111011011; //sfix16_En15
  parameter signed [15:0] coeff13 = 16'b1111111100111000; //sfix16_En15
  parameter signed [15:0] coeff14 = 16'b0000000001010111; //sfix16_En15
  parameter signed [15:0] coeff15 = 16'b0000000100001101; //sfix16_En15
  parameter signed [15:0] coeff16 = 16'b1111111101011001; //sfix16_En15
  parameter signed [15:0] coeff17 = 16'b1111111010101000; //sfix16_En15
  parameter signed [15:0] coeff18 = 16'b0000000100011111; //sfix16_En15
  parameter signed [15:0] coeff19 = 16'b0000000110100110; //sfix16_En15
  parameter signed [15:0] coeff20 = 16'b1111111000110011; //sfix16_En15
  parameter signed [15:0] coeff21 = 16'b1111111000001100; //sfix16_En15
  parameter signed [15:0] coeff22 = 16'b0000001011001101; //sfix16_En15
  parameter signed [15:0] coeff23 = 16'b0000001000111100; //sfix16_En15
  parameter signed [15:0] coeff24 = 16'b1111101110101011; //sfix16_En15
  parameter signed [15:0] coeff25 = 16'b1111110110000011; //sfix16_En15
  parameter signed [15:0] coeff26 = 16'b0000011011110101; //sfix16_En15
  parameter signed [15:0] coeff27 = 16'b0000001010110001; //sfix16_En15
  parameter signed [15:0] coeff28 = 16'b1111001101000100; //sfix16_En15
  parameter signed [15:0] coeff29 = 16'b1111110100101010; //sfix16_En15
  parameter signed [15:0] coeff30 = 16'b0010100001010011; //sfix16_En15
  parameter signed [15:0] coeff31 = 16'b0100001100010000; //sfix16_En15
  parameter signed [15:0] coeff32 = 16'b0010100001010011; //sfix16_En15
  parameter signed [15:0] coeff33 = 16'b1111110100101010; //sfix16_En15
  parameter signed [15:0] coeff34 = 16'b1111001101000100; //sfix16_En15
  parameter signed [15:0] coeff35 = 16'b0000001010110001; //sfix16_En15
  parameter signed [15:0] coeff36 = 16'b0000011011110101; //sfix16_En15
  parameter signed [15:0] coeff37 = 16'b1111110110000011; //sfix16_En15
  parameter signed [15:0] coeff38 = 16'b1111101110101011; //sfix16_En15
  parameter signed [15:0] coeff39 = 16'b0000001000111100; //sfix16_En15
  parameter signed [15:0] coeff40 = 16'b0000001011001101; //sfix16_En15
  parameter signed [15:0] coeff41 = 16'b1111111000001100; //sfix16_En15
  parameter signed [15:0] coeff42 = 16'b1111111000110011; //sfix16_En15
  parameter signed [15:0] coeff43 = 16'b0000000110100110; //sfix16_En15
  parameter signed [15:0] coeff44 = 16'b0000000100011111; //sfix16_En15
  parameter signed [15:0] coeff45 = 16'b1111111010101000; //sfix16_En15
  parameter signed [15:0] coeff46 = 16'b1111111101011001; //sfix16_En15
  parameter signed [15:0] coeff47 = 16'b0000000100001101; //sfix16_En15
  parameter signed [15:0] coeff48 = 16'b0000000001010111; //sfix16_En15
  parameter signed [15:0] coeff49 = 16'b1111111100111000; //sfix16_En15
  parameter signed [15:0] coeff50 = 16'b1111111111011011; //sfix16_En15
  parameter signed [15:0] coeff51 = 16'b0000000010001100; //sfix16_En15
  parameter signed [15:0] coeff52 = 16'b0000000000001000; //sfix16_En15
  parameter signed [15:0] coeff53 = 16'b1111111110100110; //sfix16_En15
  parameter signed [15:0] coeff54 = 16'b0000000000000101; //sfix16_En15
  parameter signed [15:0] coeff55 = 16'b0000000000110100; //sfix16_En15
  parameter signed [15:0] coeff56 = 16'b1111111111111000; //sfix16_En15
  parameter signed [15:0] coeff57 = 16'b1111111111100111; //sfix16_En15
  parameter signed [15:0] coeff58 = 16'b0000000000000110; //sfix16_En15
  parameter signed [15:0] coeff59 = 16'b0000000000001000; //sfix16_En15
  ...
  assign product59 = $signed({delay_pipeline[58][11:0], 8'b00000000});

  assign mul_temp = delay_pipeline[57] * coeff58;
  assign product58 = $signed({mul_temp[25:0], 5'b00000});

  assign mul_temp_1 = delay_pipeline[56] * coeff57;
  assign product57 = $signed({mul_temp_1[25:0], 5'b00000});

  assign mulpwr2_temp_1 = (delay_pipeline[55]==12'b100000000000) ? $signed({1'b0, delay_pipeline[55]}) : -delay_pipeline[55];

  assign product56 = $signed({mulpwr2_temp_1[12:0], 8'b00000000});

  assign mul_temp_2 = delay_pipeline[54] * coeff55;
  assign product55 = $signed({mul_temp_2[25:0], 5'b00000});

  assign mul_temp_3 = delay_pipeline[53] * coeff54;
  assign product54 = $signed({mul_temp_3[25:0], 5'b00000});

  assign mul_temp_4 = delay_pipeline[52] * coeff53;
  assign product53 = $signed({mul_temp_4[25:0], 5'b00000});

  assign product52 = $signed({delay_pipeline[51][11:0], 8'b00000000});

  assign mul_temp_5 = delay_pipeline[50] * coeff51;
  assign product51 = $signed({mul_temp_5[25:0], 5'b00000});

  assign mul_temp_6 = delay_pipeline[49] * coeff50;
  assign product50 = $signed({mul_temp_6[25:0], 5'b00000});

  assign mul_temp_7 = delay_pipeline[48] * coeff49;
  assign product49 = $signed({mul_temp_7[25:0], 5'b00000});

  assign mul_temp_8 = delay_pipeline[47] * coeff48;
  assign product48 = $signed({mul_temp_8[25:0], 5'b00000});

  assign mul_temp_9 = delay_pipeline[46] * coeff47;
  assign product47 = $signed({mul_temp_9[25:0], 5'b00000});

  assign mul_temp_10 = delay_pipeline[45] * coeff46;
  assign product46 = $signed({mul_temp_10[25:0], 5'b00000});

  assign mul_temp_11 = delay_pipeline[44] * coeff45;
  assign product45 = $signed({mul_temp_11[25:0], 5'b00000});

  assign mul_temp_12 = delay_pipeline[43] * coeff44;
  assign product44 = $signed({mul_temp_12[25:0], 5'b00000});

  assign mul_temp_13 = delay_pipeline[42] * coeff43;
  assign product43 = $signed({mul_temp_13[25:0], 5'b00000});

  assign mul_temp_14 = delay_pipeline[41] * coeff42;
  assign product42 = $signed({mul_temp_14[25:0], 5'b00000});

  assign mul_temp_15 = delay_pipeline[40] * coeff41;
  assign product41 = $signed({mul_temp_15[25:0], 5'b00000});

  assign mul_temp_16 = delay_pipeline[39] * coeff40;
  assign product40 = $signed({mul_temp_16[25:0], 5'b00000});

  assign mul_temp_17 = delay_pipeline[38] * coeff39;
  assign product39 = $signed({mul_temp_17[25:0], 5'b00000});

  assign mul_temp_18 = delay_pipeline[37] * coeff38;
  assign product38 = $signed({mul_temp_18[25:0], 5'b00000});

  assign mul_temp_19 = delay_pipeline[36] * coeff37;
  assign product37 = $signed({mul_temp_19[25:0], 5'b00000});

  assign mul_temp_20 = delay_pipeline[35] * coeff36;
  assign product36 = $signed({mul_temp_20[25:0], 5'b00000});

  assign mul_temp_21 = delay_pipeline[34] * coeff35;
  assign product35 = $signed({mul_temp_21[25:0], 5'b00000});

  assign mul_temp_22 = delay_pipeline[33] * coeff34;
  assign product34 = $signed({mul_temp_22[25:0], 5'b00000});

  assign mul_temp_23 = delay_pipeline[32] * coeff33;
  assign product33 = $signed({mul_temp_23[25:0], 5'b00000});

  assign mul_temp_24 = delay_pipeline[31] * coeff32;
  assign product32 = $signed({mul_temp_24[25:0], 5'b00000});

  assign mul_temp_25 = delay_pipeline[30] * coeff31;
  assign product31 = $signed({mul_temp_25[25:0], 5'b00000});

  assign mul_temp_26 = delay_pipeline[29] * coeff30;
  assign product30 = $signed({mul_temp_26[25:0], 5'b00000});

  assign mul_temp_27 = delay_pipeline[28] * coeff29;
  assign product29 = $signed({mul_temp_27[25:0], 5'b00000});

  assign mul_temp_28 = delay_pipeline[27] * coeff28;
  assign product28 = $signed({mul_temp_28[25:0], 5'b00000});

  assign mul_temp_29 = delay_pipeline[26] * coeff27;
  assign product27 = $signed({mul_temp_29[25:0], 5'b00000});

  assign mul_temp_30 = delay_pipeline[25] * coeff26;
  assign product26 = $signed({mul_temp_30[25:0], 5'b00000});

  assign mul_temp_31 = delay_pipeline[24] * coeff25;
  assign product25 = $signed({mul_temp_31[25:0], 5'b00000});

  assign mul_temp_32 = delay_pipeline[23] * coeff24;
  assign product24 = $signed({mul_temp_32[25:0], 5'b00000});

  assign mul_temp_33 = delay_pipeline[22] * coeff23;
  assign product23 = $signed({mul_temp_33[25:0], 5'b00000});

  assign mul_temp_34 = delay_pipeline[21] * coeff22;
  assign product22 = $signed({mul_temp_34[25:0], 5'b00000});

  assign mul_temp_35 = delay_pipeline[20] * coeff21;
  assign product21 = $signed({mul_temp_35[25:0], 5'b00000});

  assign mul_temp_36 = delay_pipeline[19] * coeff20;
  assign product20 = $signed({mul_temp_36[25:0], 5'b00000});

  assign mul_temp_37 = delay_pipeline[18] * coeff19;
  assign product19 = $signed({mul_temp_37[25:0], 5'b00000});

  assign mul_temp_38 = delay_pipeline[17] * coeff18;
  assign product18 = $signed({mul_temp_38[25:0], 5'b00000});

  assign mul_temp_39 = delay_pipeline[16] * coeff17;
  assign product17 = $signed({mul_temp_39[25:0], 5'b00000});

  assign mul_temp_40 = delay_pipeline[15] * coeff16;
  assign product16 = $signed({mul_temp_40[25:0], 5'b00000});

  assign mul_temp_41 = delay_pipeline[14] * coeff15;
  assign product15 = $signed({mul_temp_41[25:0], 5'b00000});

  assign mul_temp_42 = delay_pipeline[13] * coeff14;
  assign product14 = $signed({mul_temp_42[25:0], 5'b00000});

  assign mul_temp_43 = delay_pipeline[12] * coeff13;
  assign product13 = $signed({mul_temp_43[25:0], 5'b00000});

  assign mul_temp_44 = delay_pipeline[11] * coeff12;
  assign product12 = $signed({mul_temp_44[25:0], 5'b00000});

  assign mul_temp_45 = delay_pipeline[10] * coeff11;
  assign product11 = $signed({mul_temp_45[25:0], 5'b00000});

  assign product10 = $signed({delay_pipeline[9][11:0], 8'b00000000});

  assign mul_temp_46 = delay_pipeline[8] * coeff9;
  assign product9 = $signed({mul_temp_46[25:0], 5'b00000});

  assign mul_temp_47 = delay_pipeline[7] * coeff8;
  assign product8 = $signed({mul_temp_47[25:0], 5'b00000});

  assign mul_temp_48 = delay_pipeline[6] * coeff7;
  assign product7 = $signed({mul_temp_48[25:0], 5'b00000});

  assign mulpwr2_temp_2 = (delay_pipeline[5]==12'b100000000000) ? $signed({1'b0, delay_pipeline[5]}) : -delay_pipeline[5];

  assign product6 = $signed({mulpwr2_temp_2[12:0], 8'b00000000});

  assign mul_temp_49 = delay_pipeline[4] * coeff5;
  assign product5 = $signed({mul_temp_49[25:0], 5'b00000});

  assign mul_temp_50 = delay_pipeline[3] * coeff4;
  assign product4 = $signed({mul_temp_50[25:0], 5'b00000});

  assign product3 = $signed({delay_pipeline[2][11:0], 8'b00000000});

  assign mulpwr2_temp_3 = (delay_pipeline[1]==12'b100000000000) ? $signed({1'b0, delay_pipeline[1]}) : -delay_pipeline[1];

  assign product2 = $signed({mulpwr2_temp_3[12:0], 6'b000000});
