...
// Generated on: 2022-04-19 15:58:31
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: fir48k_6_2k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000000000000; //sfix16_En16
  parameter signed [15:0] coeff2 = 16'b1111111111111001; //sfix16_En16
  parameter signed [15:0] coeff3 = 16'b1111111111110100; //sfix16_En16
  parameter signed [15:0] coeff4 = 16'b0000000000000011; //sfix16_En16
  parameter signed [15:0] coeff5 = 16'b0000000000101001; //sfix16_En16
  parameter signed [15:0] coeff6 = 16'b0000000001001100; //sfix16_En16
  parameter signed [15:0] coeff7 = 16'b0000000000111110; //sfix16_En16
  parameter signed [15:0] coeff8 = 16'b1111111111100110; //sfix16_En16
  parameter signed [15:0] coeff9 = 16'b1111111101101000; //sfix16_En16
  parameter signed [15:0] coeff10 = 16'b1111111100100010; //sfix16_En16
  parameter signed [15:0] coeff11 = 16'b1111111101110010; //sfix16_En16
  parameter signed [15:0] coeff12 = 16'b0000000001100010; //sfix16_En16
  parameter signed [15:0] coeff13 = 16'b0000000101110100; //sfix16_En16
  parameter signed [15:0] coeff14 = 16'b0000000111010111; //sfix16_En16
  parameter signed [15:0] coeff15 = 16'b0000000011110001; //sfix16_En16
  parameter signed [15:0] coeff16 = 16'b1111111011110100; //sfix16_En16
  parameter signed [15:0] coeff17 = 16'b1111110100000010; //sfix16_En16
  parameter signed [15:0] coeff18 = 16'b1111110010011101; //sfix16_En16
  parameter signed [15:0] coeff19 = 16'b1111111010100101; //sfix16_En16
  parameter signed [15:0] coeff20 = 16'b0000001001110001; //sfix16_En16
  parameter signed [15:0] coeff21 = 16'b0000010111000111; //sfix16_En16
  parameter signed [15:0] coeff22 = 16'b0000010111111101; //sfix16_En16
  parameter signed [15:0] coeff23 = 16'b0000000110111010; //sfix16_En16
  parameter signed [15:0] coeff24 = 16'b1111101001100011; //sfix16_En16
  parameter signed [15:0] coeff25 = 16'b1111010000100011; //sfix16_En16
  parameter signed [15:0] coeff26 = 16'b1111010000101110; //sfix16_En16
  parameter signed [15:0] coeff27 = 16'b1111110111111111; //sfix16_En16
  parameter signed [15:0] coeff28 = 16'b0001000011111100; //sfix16_En16
  parameter signed [15:0] coeff29 = 16'b0010011111101100; //sfix16_En16
  parameter signed [15:0] coeff30 = 16'b0011101011011000; //sfix16_En16
  parameter signed [15:0] coeff31 = 16'b0100001010000010; //sfix16_En16
  parameter signed [15:0] coeff32 = 16'b0011101011011000; //sfix16_En16
  parameter signed [15:0] coeff33 = 16'b0010011111101100; //sfix16_En16
  parameter signed [15:0] coeff34 = 16'b0001000011111100; //sfix16_En16
  parameter signed [15:0] coeff35 = 16'b1111110111111111; //sfix16_En16
  parameter signed [15:0] coeff36 = 16'b1111010000101110; //sfix16_En16
  parameter signed [15:0] coeff37 = 16'b1111010000100011; //sfix16_En16
  parameter signed [15:0] coeff38 = 16'b1111101001100011; //sfix16_En16
  parameter signed [15:0] coeff39 = 16'b0000000110111010; //sfix16_En16
  parameter signed [15:0] coeff40 = 16'b0000010111111101; //sfix16_En16
  parameter signed [15:0] coeff41 = 16'b0000010111000111; //sfix16_En16
  parameter signed [15:0] coeff42 = 16'b0000001001110001; //sfix16_En16
  parameter signed [15:0] coeff43 = 16'b1111111010100101; //sfix16_En16
  parameter signed [15:0] coeff44 = 16'b1111110010011101; //sfix16_En16
  parameter signed [15:0] coeff45 = 16'b1111110100000010; //sfix16_En16
  parameter signed [15:0] coeff46 = 16'b1111111011110100; //sfix16_En16
  parameter signed [15:0] coeff47 = 16'b0000000011110001; //sfix16_En16
  parameter signed [15:0] coeff48 = 16'b0000000111010111; //sfix16_En16
  parameter signed [15:0] coeff49 = 16'b0000000101110100; //sfix16_En16
  parameter signed [15:0] coeff50 = 16'b0000000001100010; //sfix16_En16
  parameter signed [15:0] coeff51 = 16'b1111111101110010; //sfix16_En16
  parameter signed [15:0] coeff52 = 16'b1111111100100010; //sfix16_En16
  parameter signed [15:0] coeff53 = 16'b1111111101101000; //sfix16_En16
  parameter signed [15:0] coeff54 = 16'b1111111111100110; //sfix16_En16
  parameter signed [15:0] coeff55 = 16'b0000000000111110; //sfix16_En16
  parameter signed [15:0] coeff56 = 16'b0000000001001100; //sfix16_En16
  parameter signed [15:0] coeff57 = 16'b0000000000101001; //sfix16_En16
  parameter signed [15:0] coeff58 = 16'b0000000000000011; //sfix16_En16
  parameter signed [15:0] coeff59 = 16'b1111111111110100; //sfix16_En16
  parameter signed [15:0] coeff60 = 16'b1111111111111001; //sfix16_En16
