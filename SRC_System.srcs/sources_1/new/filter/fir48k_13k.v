...
// Generated on: 2022-04-19 15:59:27
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: fir48k_13k
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  parameter signed [15:0] coeff3 = 16'b1111111111111011; //sfix16_En15
  parameter signed [15:0] coeff4 = 16'b0000000000001111; //sfix16_En15
  parameter signed [15:0] coeff5 = 16'b0000000000000111; //sfix16_En15
  parameter signed [15:0] coeff6 = 16'b1111111111011010; //sfix16_En15
  parameter signed [15:0] coeff7 = 16'b0000000000000000; //sfix16_En15
  parameter signed [15:0] coeff8 = 16'b0000000001000101; //sfix16_En15
  parameter signed [15:0] coeff9 = 16'b1111111111101001; //sfix16_En15
  parameter signed [15:0] coeff10 = 16'b1111111110010111; //sfix16_En15
  parameter signed [15:0] coeff11 = 16'b0000000001000111; //sfix16_En15
  parameter signed [15:0] coeff12 = 16'b0000000010001001; //sfix16_En15
  parameter signed [15:0] coeff13 = 16'b1111111101101101; //sfix16_En15
  parameter signed [15:0] coeff14 = 16'b1111111101101000; //sfix16_En15
  parameter signed [15:0] coeff15 = 16'b0000000100000000; //sfix16_En15
  parameter signed [15:0] coeff16 = 16'b0000000010000101; //sfix16_En15
  parameter signed [15:0] coeff17 = 16'b1111111001110101; //sfix16_En15
  parameter signed [15:0] coeff18 = 16'b1111111111000010; //sfix16_En15
  parameter signed [15:0] coeff19 = 16'b0000001000101111; //sfix16_En15
  parameter signed [15:0] coeff20 = 16'b1111111110101011; //sfix16_En15
  parameter signed [15:0] coeff21 = 16'b1111110100011111; //sfix16_En15
  parameter signed [15:0] coeff22 = 16'b0000000101010111; //sfix16_En15
  parameter signed [15:0] coeff23 = 16'b0000001110010101; //sfix16_En15
  parameter signed [15:0] coeff24 = 16'b1111110011111110; //sfix16_En15
  parameter signed [15:0] coeff25 = 16'b1111101111000101; //sfix16_En15
  parameter signed [15:0] coeff26 = 16'b0000010111100100; //sfix16_En15
  parameter signed [15:0] coeff27 = 16'b0000010011000110; //sfix16_En15
  parameter signed [15:0] coeff28 = 16'b1111001111110110; //sfix16_En15
  parameter signed [15:0] coeff29 = 16'b1111101011011000; //sfix16_En15
  parameter signed [15:0] coeff30 = 16'b0010100000010100; //sfix16_En15
  parameter signed [15:0] coeff31 = 16'b0100010101111110; //sfix16_En15
  parameter signed [15:0] coeff32 = 16'b0010100000010100; //sfix16_En15
  parameter signed [15:0] coeff33 = 16'b1111101011011000; //sfix16_En15
  parameter signed [15:0] coeff34 = 16'b1111001111110110; //sfix16_En15
  parameter signed [15:0] coeff35 = 16'b0000010011000110; //sfix16_En15
  parameter signed [15:0] coeff36 = 16'b0000010111100100; //sfix16_En15
  parameter signed [15:0] coeff37 = 16'b1111101111000101; //sfix16_En15
  parameter signed [15:0] coeff38 = 16'b1111110011111110; //sfix16_En15
  parameter signed [15:0] coeff39 = 16'b0000001110010101; //sfix16_En15
  parameter signed [15:0] coeff40 = 16'b0000000101010111; //sfix16_En15
  parameter signed [15:0] coeff41 = 16'b1111110100011111; //sfix16_En15
  parameter signed [15:0] coeff42 = 16'b1111111110101011; //sfix16_En15
  parameter signed [15:0] coeff43 = 16'b0000001000101111; //sfix16_En15
  parameter signed [15:0] coeff44 = 16'b1111111111000010; //sfix16_En15
  parameter signed [15:0] coeff45 = 16'b1111111001110101; //sfix16_En15
  parameter signed [15:0] coeff46 = 16'b0000000010000101; //sfix16_En15
  parameter signed [15:0] coeff47 = 16'b0000000100000000; //sfix16_En15
  parameter signed [15:0] coeff48 = 16'b1111111101101000; //sfix16_En15
  parameter signed [15:0] coeff49 = 16'b1111111101101101; //sfix16_En15
  parameter signed [15:0] coeff50 = 16'b0000000010001001; //sfix16_En15
  parameter signed [15:0] coeff51 = 16'b0000000001000111; //sfix16_En15
  parameter signed [15:0] coeff52 = 16'b1111111110010111; //sfix16_En15
  parameter signed [15:0] coeff53 = 16'b1111111111101001; //sfix16_En15
  parameter signed [15:0] coeff54 = 16'b0000000001000101; //sfix16_En15
  parameter signed [15:0] coeff55 = 16'b0000000000000000; //sfix16_En15
  parameter signed [15:0] coeff56 = 16'b1111111111011010; //sfix16_En15
  parameter signed [15:0] coeff57 = 16'b0000000000000111; //sfix16_En15
  parameter signed [15:0] coeff58 = 16'b0000000000001111; //sfix16_En15
  parameter signed [15:0] coeff59 = 16'b1111111111111011; //sfix16_En15
  parameter signed [15:0] coeff60 = 16'b1111111111111101; //sfix16_En15
  ...
  assign product60 = $signed({mul_temp[25:0], 5'b00000});

  assign mul_temp_1 = delay_pipeline[58] * coeff59;
  assign product59 = $signed({mul_temp_1[25:0], 5'b00000});

  assign mul_temp_2 = delay_pipeline[57] * coeff58;
  assign product58 = $signed({mul_temp_2[25:0], 5'b00000});

  assign mul_temp_3 = delay_pipeline[56] * coeff57;
  assign product57 = $signed({mul_temp_3[25:0], 5'b00000});

  assign mul_temp_4 = delay_pipeline[55] * coeff56;
  assign product56 = $signed({mul_temp_4[25:0], 5'b00000});
  ...
  assign product47 = $signed({delay_pipeline[46][11:0], 13'b0000000000000});
  ...
  assign product15 = $signed({delay_pipeline[14][11:0], 13'b0000000000000});

  assign mul_temp_43 = delay_pipeline[13] * coeff14;
  assign product14 = $signed({mul_temp_43[25:0], 5'b00000});

  assign mul_temp_44 = delay_pipeline[12] * coeff13;
  assign product13 = $signed({mul_temp_44[25:0], 5'b00000});

  assign mul_temp_45 = delay_pipeline[11] * coeff12;
  assign product12 = $signed({mul_temp_45[25:0], 5'b00000});

  assign mul_temp_46 = delay_pipeline[10] * coeff11;
  assign product11 = $signed({mul_temp_46[25:0], 5'b00000});

  assign mul_temp_47 = delay_pipeline[9] * coeff10;
  assign product10 = $signed({mul_temp_47[25:0], 5'b00000});

  assign mul_temp_48 = delay_pipeline[8] * coeff9;
  assign product9 = $signed({mul_temp_48[25:0], 5'b00000});

  assign mul_temp_49 = delay_pipeline[7] * coeff8;
  assign product8 = $signed({mul_temp_49[25:0], 5'b00000});

  assign mul_temp_50 = delay_pipeline[5] * coeff6;
  assign product6 = $signed({mul_temp_50[25:0], 5'b00000});

  assign mul_temp_51 = delay_pipeline[4] * coeff5;
  assign product5 = $signed({mul_temp_51[25:0], 5'b00000});

  assign mul_temp_52 = delay_pipeline[3] * coeff4;
  assign product4 = $signed({mul_temp_52[25:0], 5'b00000});

  assign mul_temp_53 = delay_pipeline[2] * coeff3;
  assign product3 = $signed({mul_temp_53[25:0], 5'b00000});

  assign mul_temp_54 = delay_pipeline[1] * coeff2;
  assign product2 = $signed({mul_temp_54[25:0], 5'b00000});
